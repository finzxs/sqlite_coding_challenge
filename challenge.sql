-- 1) Top 5 customers who have spent the most money on orders
SELECT
...
-- 2) Total revenue generated from each product category
SELECT
    p.category,
...
-- 3) Employees with above-average salary in their department
WITH dept_avg AS (
    SELECT
        department_id,
...
-- 4) Cities with the most Gold customers
SELECT
    city,
...
-- 4+) Loyalty distribution by city
SELECT
    city,
